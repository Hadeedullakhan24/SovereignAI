...
_VISUAL_NOUNS = r"(?:image|picture|photo|photograph|illustration|diagram|rendering|graphic|visual\s+representation|visualization|visual|artwork|drawing|sketch|scene|concept\s+art|3d\s+render)"
