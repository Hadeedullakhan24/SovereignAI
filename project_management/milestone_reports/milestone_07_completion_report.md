...
3. **Deterministic RFC 4122 UUIDv5 Identification:**
   - Qdrant requires unsigned 64-bit integers or UUID strings. The engine maps deterministic Milestone 5 chunk IDs to UUIDv5 using a fixed cryptographic namespace (`6ba7b810-9dad-11d1-80b4-00c04fd430c8`), guaranteeing 100% reproducible point addresses.
