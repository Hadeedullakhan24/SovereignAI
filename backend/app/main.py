...
async def http_error(request:Request,exc:StarletteHTTPException): return error(request,exc.status_code,{401:"AUTHENTICATION_ERROR",403:"AUTHORIZATION_ERROR",404:"RESOURCE_NOT_FOUND",409:"CONFLICT",413:"FILE_TOO_LARGE",415:"UNSUPPORTED_MEDIA_TYPE"}.get(exc.status_code,"REQUEST_ERROR"),str(exc.detail))
