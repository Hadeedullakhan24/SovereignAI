...
export const api={
 ...
 message:(id:string,content:string)=>request<{message:{id:string;role:string;content:string;model_used?:string};task_id:string}>(`/api/v1/chats/${id}/messages`,{method:"POST",body:JSON.stringify({content})}),
