...
TEMPLATES: Dict[PromptArchetype, PromptTemplate] = {
    ...
    PromptArchetype.EMAIL: PromptTemplate(
        ...
        generation_instruction=(
            ...
            "- Output ONLY the email itself (starting with 'Subject:' and ending with the sign-off). Do not include conversational preambles or postambles.\n"
            "- Do NOT include References, Sources, Provenance, citations [n], document IDs (filenames), page numbers, or retrieved-chunk text inside the generated email.\n"
