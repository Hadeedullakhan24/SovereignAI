...
MODEL_SPECIFICATIONS: Dict[str, Dict[str, Any]] = {
    ...
    "microsoft/Phi-3.5-mini-instruct": {
        "family": "phi3.5",
        "description": "High-efficiency 3.8B model with strong technical and long-context reasoning",
    ...
    "HuggingFaceTB/SmolLM2-1.7B-Instruct": {
        "family": "smollm",
        "description": "Compact, high-speed 1.7B conversational model for lightweight local inference",
        "context_window": 8192,
        "default_quantization": "fp16",
